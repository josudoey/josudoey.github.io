// see https://docusaurus.community/knowledge/component-library/new/TimeLine/#creating-the-subcomponent-singletimelineitem
...
const SingleTimeLineItem: React.FC<SingleTimeLineItemProps> = ({
  ...
  const bgcolor = variant ? styles[`singletimeline__content--${variant}`] : ''
  const itemalign = align ? styles[`singletimeline__item--${align}`] : ''
  ...
  return (
    <div className={clsx(styles.singletimeline__item, itemalign)}>
      <div
        className={clsx(
          styles.singletimeline__content,
          bgcolor,
          className,
          boxshadow,
          text,
